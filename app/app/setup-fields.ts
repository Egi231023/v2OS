...
export const setupFields={
 'task.assign':[{name:'actorId',label:'Responsible person (existing access required)',type:'actor',required:true},{name:'dueAt',label:'Next deadline',type:'datetime-local',required:true},{name:'reason',label:'Assignment reason',required:true}],
